...
var _react = _interopRequireDefault(__webpack_require__(/*! react */ "./node_modules/@neos-project/neos-ui-extensibility/src/shims/vendor/react/index.js"));
...
var _dateInput = __webpack_require__(/*! ./dateInput */ "./src/dateInput.js");
...
var DateTimeEditor = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
        i18nRegistry: globalRegistry.get('i18n')
    };
}), _dec2 = (0, _reactRedux.connect)(function (state) {
    return (0, _plowJs.$transform)({
        interfaceLanguage: (0, _plowJs.$get)('user.preferences.interfaceLanguage')
    });
    ...
    function DateTimeEditor() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DateTimeEditor.__proto__ || Object.getPrototypeOf(DateTimeEditor)).call.apply(_ref, [this].concat(args))), _this), _this.state = { selectedTimezone: null }, _this.hasTimezoneSupport = function () {
            var options = _this.props.options;

            return !!(0, _plowJs.$get)('timezoneSupport', options);
        }, _this.preferredDisplayTimezone = function () {
            var options = _this.props.options;

            return (0, _plowJs.$get)('preferredTimezone', options) || null;
        }, _this.decideDisplayTimezone = function () {
            if (!_this.hasTimezoneSupport()) {
                return 'UTC';
            }
            return _this.state.selectedTimezone || _this.preferredDisplayTimezone || _momentTimezone2.default.tz.guess();
        }, _this.onTimezoneChange = function (selectedTimezone) {
            _this.setState({
                selectedTimezone: selectedTimezone
            });
        }, _this.onChange = function (date) {
            var momentObject = date && ((0, _momentTimezone.isMoment)(date) ? date : (0, _momentTimezone2.default)(date));
            _this.props.commit(momentObject ? momentObject.format('YYYY-MM-DDTHH:mm:ssZ') : '');
    ...
    _createClass(DateTimeEditor, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                interfaceLanguage = _props.interfaceLanguage;

            var mappedValue = typeof value === 'string' && value.length ? (0, _momentTimezone2.default)(value).utc().toDate() : value || undefined;
            var timezoneSupport = this.hasTimezoneSupport();

            var timeConstraints = Object.assign({
                minutes: {
                    step: (0, _plowJs.$get)('minuteStep', options) || 5
                }
            }, (0, _plowJs.$get)('timeConstraints', options));
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_dateInput2.default, {
                    ...
                    labelFormat: (0, _helpers2.default)(options.format),
                    dateOnly: !(0, _helpers.hasTimeFormat)(options.format),
                    timeOnly: !(0, _helpers.hasDateFormat)(options.format),
                    placeholder: i18nRegistry.translate((0, _plowJs.$get)('placeholder', options) || 'Neos.Neos:Main:content.inspector.editors.dateTimeEditor.noDateSet'),
    ...
    interfaceLanguage: _propTypes2.default.string
...
var _reactCollapse = __webpack_require__(/*! react-collapse */ "./node_modules/react-collapse/lib/index.js");

var _reactCollapse2 = _interopRequireDefault(_reactCollapse);

var _reactDatetime = __webpack_require__(/*! react-datetime */ "./node_modules/react-datetime/dist/react-datetime.cjs.js");
...
var ExtendedDateInput = (_temp2 = _class = function (_DateInput) {
    _inherits(ExtendedDateInput, _DateInput);

    function ExtendedDateInput() {
        var _ref;

        var _temp, _this, _ret;

        _classCallCheck(this, ExtendedDateInput);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ExtendedDateInput.__proto__ || Object.getPrototypeOf(ExtendedDateInput)).call.apply(_ref, [this].concat(args))), _this), _this.state = { isOpen: false, transientDate: null, selectedTimezone: null }, _this.renderTimezoneSelector = function (timezone) {
            var mappedOptions = _momentTimezone2.default.tz.names().map(function (timezoneName) {
            ...
            return _react2.default.createElement(_reactUiComponents.SelectBox, {
                ...
                ListPreviewElement: _reactUiComponents.SelectBox_Option_SingleLine,
                value: timezone,
                allowEmpty: false,
                displaySearchBox: false,
                threshold: 0,
                onValueChange: _this.props.onDisplayTimezoneChange
            });
        ...
        }, _this.handleClearValueClick = function () {
            if (!_this.props.disabled) {
            ...
            _this.setState({
                ...
                _this.props.onChange(_this.state.transientDate ? _this.state.transientDate.utc().toDate() : null);
            });
        }, _this.handleChange = function (value) {
            var momentVal = (0, _momentTimezone.isMoment)(value) ? value : (0, _momentTimezone2.default)(value);
            _this.setState({
                transientDate: momentVal
            });
        }, _this.handleSelectTodayBtnClick = function () {
            _this.setState({
                isOpen: false
            }, function () {
                var date = (0, _momentTimezone2.default)().toDate();
                if (_this.props.dateOnly) {
                    date = (0, _momentTimezone2.default)().utc().startOf('day').toDate();
                }
    ...
    _createClass(ExtendedDateInput, [{
        key: 'render',
        value: function render() {
            var _this2 = this;
            ...
            var _props = this.props,
                ...
                applyLabel = _props.applyLabel,
                labelFormat = _props.labelFormat,
                dateOnly = _props.dateOnly,
                timeOnly = _props.timeOnly,
                locale = _props.locale,
                disabled = _props.disabled,
                timezoneSupport = _props.timezoneSupport,
                displayTimezone = _props.displayTimezone;

            var incomingValueMoment = value ? (0, _momentTimezone2.default)(value) : undefined;
            var editedValue = this.state.transientDate ? this.state.transientDate : incomingValueMoment;
            var displayedDate = editedValue && displayTimezone ? (0, _momentTimezone2.default)(editedValue).tz(displayTimezone).format(labelFormat) : '';

            var wrapper = (0, _classnames2.default)(_style2.default.wrapper, _defineProperty({}, _style2.default.disabled, disabled));

            var calendarInputWrapper = (0, _classnames2.default)(className, _style2.default.calendarInputWrapper);

            var calendarFakeInputMirror = (0, _classnames2.default)(_style2.default.calendarFakeInputMirror, _defineProperty({}, _style2.default['disabled-cursor'], disabled));

            var calendarIconBtn = (0, _classnames2.default)(_style2.default.calendarIconBtn, _defineProperty({}, _style2.default['disabled-cursor'], disabled));

            var closeCalendarIconBtn = (0, _classnames2.default)(_style2.default.closeCalendarIconBtn, _defineProperty({}, _style2.default['disabled-cursor'], disabled));
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_reactUiComponents.Icon, { icon: 'far calendar-alt' })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: _style2.default.calendarFakeInputWrapper },
                        ...
                        _react2.default.createElement('input', {
                            ...
                            className: _style2.default.calendarFakeInput,
                            value: displayedDate,
                            readOnly: true
                        })
                    ),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        {
                            className: _style2.default.selectTodayBtn,
                    ...
                    timezoneSupport && _react2.default.createElement(
                        'div',
                        null,
                        this.renderTimezoneSelector(displayTimezone || '')
                    ),
                    _react2.default.createElement(
                        _reactUiComponents.Button,
                        {
                            onClick: this.handleApply,
                            className: _style2.default.applyBtn,
                            style: 'brand',
    ...
    return ExtendedDateInput;
}(_reactUiComponents.DateInput), _class.defaultProps = {
...
exports.default = ExtendedDateInput;
...
exports.default = function (format) {
    ...
    return format.replace(/[dDjlNwWFmMnoYyaAgGhHisOPU]/g, function (phpStr) {
...
//
var hasDateFormat = exports.hasDateFormat = function hasDateFormat(format) {
    return (/[yYFmMntdDjlNSw]/.test(format)
    );
};
...
//
var hasTimeFormat = exports.hasTimeFormat = function hasTimeFormat(format) {
    return (/[gGhHis]/.test(format)
    );
};
...
var _DateTimeEditor = __webpack_require__(/*! ./DateTimeEditor */ "./src/DateTimeEditor.js");

var _DateTimeEditor2 = _interopRequireDefault(_DateTimeEditor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('Flownative.Neos.ExtendedTimeEditor/DateTimeEditor', {}, function (globalRegistry) {
    var editorsRegistry = globalRegistry.get('inspector').get('editors');

    console.log(_DateTimeEditor2.default);
    editorsRegistry.set('Flownative.Neos.ExtendedTimeEditor/DateTimeEditor', {
        component: _DateTimeEditor2.default
    });
});
...
module.exports = {"calendarInputWrapper":"style__calendarInputWrapper___3Ccpl","calendarInputWrapper--highlight":"style__calendarInputWrapper--highlight___1IsBv","calendarInputWrapper--invalid":"style__calendarInputWrapper--invalid___2YKMQ","closeCalendarIconBtn":"style__closeCalendarIconBtn___2NUua reset__reset___3Y_S-","calendarIconBtn":"style__calendarIconBtn___1INMC reset__reset___3Y_S-","calendarFakeInputWrapper":"style__calendarFakeInputWrapper___vb1K8 reset__reset___3Y_S-","calendarFakeInputMirror":"style__calendarFakeInputMirror___3Y-o1","calendarFakeInput":"style__calendarFakeInput___29QiV reset__reset___3Y_S-","selectTodayBtn":"style__selectTodayBtn___3hdS2","applyBtn":"style__applyBtn___19okH","wrapper":"style__wrapper___cQFyX reset__reset___3Y_S-","disabled":"style__disabled___2uKn_","disabled-cursor":"style__disabled-cursor___1dEtq"};
